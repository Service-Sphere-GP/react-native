  ...
  <View className="flex-row items-start">
    ...
    <View className="flex-1">
      ...
      <Text className="text-sm sm:text-base text-gray-700 leading-relaxed">
        Transforming the service marketplace with AI-driven solutions
      </Text>
    </View>
  </View>
</View>
...
<View className="bg-gray-100 rounded-2xl p-4 sm:p-5 mb-4">
  <View className="flex-row items-start">
    ...
    <View className="flex-1">
      ...
      <Text className="text-sm sm:text-base text-gray-700 leading-relaxed">
        AI feedback analysis, service provider validation, predictive analytics
      </Text>
    </View>
  </View>
</View>
              ...
              <View className="flex-row justify-between items-center">
                ...
                <View className="flex-1 items-center">
                  <View className="flex-row items-center mb-1">
                    ...
                    <Ionicons name="star" size={screenWidth < 400 ? 16 : 20} color="#F59E0B" />
                  </View>
                  <Text className="text-xs sm:text-sm text-gray-500 font-Roboto-Medium">
                    Rating
                  </Text>
